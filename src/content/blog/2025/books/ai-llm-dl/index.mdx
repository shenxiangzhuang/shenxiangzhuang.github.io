---
title: 'AI / LLM / Deep Learning Books'
description: '大语言模型、NLP 和深度学习基础相关书籍推荐。'
date: 2025-01-03
tags: ['AI', '书评']
...
import d2lCover from '../images/d2l.png'
import grokkingDlCover from '../images/grokking_dl.jpg'
import llmFromScratchCover from '../images/llm_from_scratch.png'
import nlpWithTransformerCover from '../images/nlp_with_transformer.png'
import nndlCover from '../images/nndl.png'
import nnfsCover from '../images/nnfs.png'
import superLlmCover from '../images/super_llm.png'
...
这本书远虽然没有上面 _Build a Large Language Model (From Scratch)_ 有名，但是论内容，我认为这本是有过之而无不及的。

</BookReview>

<BookReview
  title="Natural Language Processing with Transformers"
  cover={nlpWithTransformerCover.src}
>
...
<Callout variant="remark" title="It just means you don't know it">
  Not knowing something doesn't mean you're dumb — it just means you don't know
  it. —— Jamie Zawinski
</Callout>
...
<BookReview
  title="Neural Networks and Deep Learning (NNDL)"
  cover={nndlCover.src}
  coverAlt="神经网络与深度学习"
>
...
<Callout variant="remark" title="Insight is forever">
  You need to understand the durable, lasting insights underlying how neural
  networks work. Technologies come and technologies go, but insight is forever.
  —— Michael Nielsen
</Callout>
...
转折点是在一本书，Michael Nielsen 的 Neural Network and Deep Learning.
</Callout>
</BookReview>
...
<BookReview title="Dive into Deep Learning (D2L)" cover={d2lCover.src}>
...
<BookReview title="Grokking Deep Learning" cover={grokkingDlCover.src}>
...
<Callout variant="note" title="LLM in 2024">
  如果你之前读过我写的 [LLM in
  2024](https://datahonor.com/blog/2024/12/23/ai_think_2024/)，
  且恰好还记得文中将 LLM
  比作一台巨大的机器，且觉得这个类比很有意思，那么这本书可能会让你有所启发:)
  文章中的类比灵感其实就是来自这本书。
</Callout>
