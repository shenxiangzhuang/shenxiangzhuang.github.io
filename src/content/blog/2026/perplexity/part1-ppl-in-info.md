...
这时候如果你对于所有马都使用 `000`-`111` 的 3 位编码就太浪费了。因为虽然你每次都发 3 个字，但绝大多数时候你发的都是“Horse 1”赢了的消息。
...
| 马号 | 概率 $P(x)$ | 巧妙的编码 | 实际长度 $l_i$ |
| :--- | :--- | :--- | :--- |
| Horse 1 | 1/2 | `0` | 1 |
| Horse 2 | 1/4 | `10` | 2 |
| Horse 3 | 1/8 | `110` | 3 |
| Horse 4 | 1/16 | `1110` | 4 |
| Horse 5 | 1/64 | `111100` | 6 |
| Horse 6 | 1/64 | `111101` | 6 |
| Horse 7 | 1/64 | `111110` | 6 |
| Horse 8 | 1/64 | `111111` | 6 |
